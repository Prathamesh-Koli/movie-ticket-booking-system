...
public class SeatSelectionController {
    ...
    @PostMapping("/reserve")
    public ResponseEntity<ReservationResponseDTO> reserveSeats( @RequestBody ReservationRequestDTO req) {
        ReservationResponseDTO res = reservationService.reserveSeats(req);
